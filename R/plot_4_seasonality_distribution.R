...
x_eta <- h5read("data/seasonality_bias_examples.jld2", "x_eta")
x_r <- h5read("data/seasonality_bias_examples.jld2", "x_r")
y_inc <- h5read("data/seasonality_bias_examples.jld2", "y_inc")
